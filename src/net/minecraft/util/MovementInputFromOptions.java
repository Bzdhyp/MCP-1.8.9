...
import com.clientbase.events.EventMoveInput;
...
public class MovementInputFromOptions extends MovementInput {
    ...
    public void updatePlayerMoveState() {
        ...
        EventMoveInput moveInputEvent = new EventMoveInput(moveForward, moveStrafe, jump, sneak, 0.3D);

        Wrapper.instance.getEventProtocol().call(moveInputEvent);
